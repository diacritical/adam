defmodule AdamWeb.EndpointTest do
  ...
  describe "call/2" do
    ...
    test "success", %{
      ...
      assert text_response(call(conn.valid, opt), status.ok) == resp_body.hello
    end
  end
  ...
  describe "hello/2" do
    ...
    test "success", %{
      ...
      assert text_response(hello(conn.valid, opt), status.ok) == resp_body.hello
    end
  end
end
